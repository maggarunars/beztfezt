...
document.addEventListener('DOMContentLoaded', function () {
    const eventContainer = document.querySelector("#eventContainer"); // finds the html element id=eventContainer and assigns it the variable "eventContainer"
            ...
            <div class="flex flex-col justify-evenly w-full">
                ...
                <div class="flex justify-between px-4 gap-3">
                    <div class="flex items-center"> 
                        ...
                        <img src="images/musicIcon.svg" alt="share icon">
                    </div>
                    <div>
